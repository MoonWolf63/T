...
{
   tcp[1] = RTB_Networking.createFactory("game.mawstudios.com","80","/apiForum.php");
   tcp[2] = RTB_Networking.createFactory("game.mawstudios.com","80","/apiForum.php");
   tcp[3] = RTB_Networking.createFactory("game.mawstudios.com","80","/apiForum.php");
};
